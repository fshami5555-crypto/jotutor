...
const FeaturesSection: React.FC<FeaturesSectionProps> = ({ strings }) => {
  const features = [
    {
    ...
    <section id="features" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-blue-900">{strings.featuresTitle}</h2>
          <p className="mt-4 text-lg text-gray-600">{strings.featuresSubtitle}</p>
        </div>
