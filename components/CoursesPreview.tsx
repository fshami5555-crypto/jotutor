...
import { Course, Currency, Page } from '../types';
...
const CoursesPreview: React.FC<CoursesPreviewProps> = ({ courses, onSelectCourse, onNavigate, currency, exchangeRate, strings }) => {
        ...
        <section id="courses-preview" className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-extrabold text-blue-900">{strings.coursesPreviewTitle}</h2>
                    <p className="mt-4 text-lg text-gray-600">{strings.coursesPreviewSubtitle}</p>
                </div>
