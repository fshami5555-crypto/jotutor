...
const AdminNav: React.FC<AdminNavProps> = ({ activeView, setActiveView, onLogout, strings }) => {
    const navItems = [
    ...
    return (
        <aside className="md:w-64 bg-white p-6 rounded-xl shadow-lg flex-shrink-0 w-full">
            <div className="text-center mb-8">
                <h3 className="font-bold text-xl mt-4 text-blue-900">{strings.adminPanelTitle}</h3>
            </div>
